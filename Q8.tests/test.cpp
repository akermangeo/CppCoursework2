...
TEST(TestCaseName, Identity_equals_1) {
	...
	double epsilon = 0.000000001;
	double actual = bisection_method<IdentityFunctor>(0., 2., -0.12321321321, epsilon, functor);
...
TEST(TestCaseName, Cube_equals_1) {
	...
	double epsilon = 0.000000001;
	double actual = pow(bisection_method<CubeFunctor>(0., 2., -0.12321321321, epsilon, functor), 3);
	EXPECT_TRUE((actual <= 1+epsilon) && (actual >= 1-epsilon));
}
...
TEST(TestCaseName, Identity_equals_0_2) {
	IdentityFunctor functor(0);
	double epsilon = 0.000000001;
	double actual = bisection_method<IdentityFunctor>(0., -0.12321321321, 1, epsilon, functor);
	EXPECT_TRUE((actual <= epsilon) && (actual >= -epsilon));
}
...
TEST(TestCaseName, Cube_equals_0_2) {
	CubeFunctor functor(0);
	double epsilon = 0.000000001;
	double actual = pow(bisection_method<CubeFunctor>(0., -0.12321321321, 1, epsilon, functor), 3);
	EXPECT_TRUE((actual <= epsilon) && (actual >= -epsilon));
}
...
TEST(TestCaseName, Identity_equals_1_2) {
	IdentityFunctor functor(0);
	double epsilon = 0.000000001;
	double actual = bisection_method<IdentityFunctor>(1, 2., -0.12321321321, epsilon, functor);
	EXPECT_TRUE((actual <= 1 + epsilon) && (actual >= 1 - epsilon));
}
...
TEST(TestCaseName, Cube_equals_1_2) {
	CubeFunctor functor(0);
	double epsilon = 0.000000001;
	double actual = pow(bisection_method<CubeFunctor>(1, 2., -0.12321321321, epsilon, functor), 3);
	EXPECT_TRUE((actual <= 1 + epsilon) && (actual >= 1 - epsilon));
}